...
function MSK.GetClosestVehicles(coords, distance)
    return MSK.GetClosestEntities(false, coords, distance)
end
...
exports('GetVehicleInFront', MSK.GetVehicleInDirection)

function MSK.GetPedVehicleSeat(playerPed, vehicle)
...
function MSK.IsVehicleEmpty(vehicle)
...
function MSK.GetVehicleLabel(vehicle, model)
...
function MSK.GetVehicleLabelFromModel(model)
...
function MSK.CloseVehicleDoors(vehicle)
