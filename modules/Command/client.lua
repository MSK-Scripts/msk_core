...
local function RegisterHotkey(commandName, properties)
...
local function parseArgs(source, args, raw, params)
    if not params then return args end

    local function DoesPlayerExist(playerId)
