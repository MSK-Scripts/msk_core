...
## Corpus Check
- 11 files · ~99,062 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 603 nodes · 756 edges · 85 communities (78 shown, 7 thin omitted)
- Extraction: 84% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.84)
- Token cost: 252,704 input · 0 output

## Community Hubs (Navigation)
- React NUI Components
- Contribution and Repo Policy
- NUI Dependency Manifest
- Core Boot and Export Registry
- TypeScript Build Config
- Vehicle Helpers Client
- MSK Brand Identity
- NUI App Shell and Error Boundary
- Keyboard List Menu
- Numpad Error State
- NUI Dev Panel
- Input Dialog Small
...
- Vector Helpers
- Pull Request Rules
- Consumer Module Loader
- Version and Dependency Check
- Commands Client
- Entity Helpers Server
- Disconnect Display Client
- License Text

## God Nodes (most connected - your core abstractions)
1. `compilerOptions` - 17 edges
2. `useNuiEvent()` - 15 edges
3. `fetchNui()` - 10 edges
4. `msk_core README Banner` - 10 edges
5. `parseColorCodes()` - 9 edges
6. `playSound()` - 9 edges
...
Cohesion: 0.07
Nodes (48): clamp(), ContextMenu(), ContextRow(), firstSelectable(), normalizeMeta(), Input(), clamp(), ListMenu() (+40 more)

### Community 1 - "Contribution and Repo Policy"
Cohesion: 0.07
...
### Community 3 - "Core Boot and Export Registry"
Cohesion: 0.09
Nodes (22): logging(), mountCore(), registerExport(), allowAce(), checkParams(), MSK.AddAce(), MSK.AddPrincipal(), MSK.IsPrincipalAceAllowed() (+14 more)
...
### Community 5 - "Vehicle Helpers Client"
Cohesion: 0.11
...
### Community 6 - "MSK Brand Identity"
Cohesion: 0.17
...
### Community 7 - "NUI App Shell and Error Boundary"
Cohesion: 0.18
Nodes (5): CoordsHandler(), copyFallback(), ErrorBoundary, Props, State

### Community 8 - "Keyboard List Menu"
Cohesion: 0.32
Nodes (12): firstSelectable(), Menu.Hide(), Menu.Register(), Menu.Show(), Menu.Update(), move(), normalizeItems(), refresh() (+4 more)

### Community 9 - "Numpad Error State"
Cohesion: 0.23
...
### Community 11 - "NUI Dev Panel"
Cohesion: 0.24
Nodes (8): contextOptions(), DevPanel(), menuItems(), NOTIFY_TYPES, send(), ContextOption, MenuItem, NuiMessage

### Community 12 - "Input Dialog Small"
Cohesion: 0.33
...
### Community 13 - "Input Dialog Large"
Cohesion: 0.31
...
### Community 15 - "Numpad Masked Input"
Cohesion: 0.33
...
### Community 16 - "Numpad Keypad Layout"
Cohesion: 0.31
...
### Community 20 - "CI Workflows and Dependabot"
Cohesion: 0.32
...
### Community 25 - "TextUI Hint Design"
Cohesion: 0.48
...
### Community 27 - "Cron Scheduler"
Cohesion: 0.43
Nodes (4): createUniqueId(), getTime(), MSK.Cron.Create(), tickCronJob()

### Community 29 - "Scaleform Client"
Cohesion: 0.57
...
### Community 30 - "Progressbar Client"
Cohesion: 0.60
Nodes (4): interrupted(), Progress.Start(), Progress.Stop(), setProgressData()

### Community 33 - "Community Code of Conduct"
Cohesion: 0.40
...
### Community 42 - "Consumer Module Loader"
Cohesion: 0.83
Nodes (3): compile(), mount(), resolve()

### Community 45 - "Entity Helpers Server"
Cohesion: 0.83
Nodes (3): getEntities(), MSK.GetClosestEntities(), MSK.GetClosestEntity()
...
- **What is the exact relationship between `Skewed Parallelogram Bar Geometry` and `Rationale: Glanceable In-Game HUD Feedback`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `logging()` connect `Core Boot and Export Registry` to `Cron Scheduler`?**
